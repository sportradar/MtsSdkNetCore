...
namespace Sportradar.MTS.SDK.Common.Internal.Rest
{
    ...
    {
        private static readonly ILogger RestLog = SdkLoggerFactory.GetLoggerForRestTraffic(typeof(HttpDataRestful));
        ...
        public virtual async Task<HttpResponseMessage> PutDataAsync(Uri uri, HttpContent content = null)
        {
            ...
            try
            {
                RestLog.LogInformation($"PutDataAsync url: {uri.AbsoluteUri}");
        ...
        public virtual async Task<HttpResponseMessage> DeleteDataAsync(Uri uri)
        {
            ...
            try
            {
                RestLog.LogInformation($"DeleteDataAsync url: {uri.AbsoluteUri}");
